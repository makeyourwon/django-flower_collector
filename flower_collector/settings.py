"""
Django settings for flower_collector project.
...
SECRET_KEY = 'django-insecure-(!3vf@a=!bc-swxbubter1&p6fz1t6+f%)s&k*v@u5=y_5b2r7'
...
ROOT_URLCONF = 'flower_collector.urls'
...
WSGI_APPLICATION = 'flower_collector.wsgi.application'
